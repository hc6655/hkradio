...
data class ChannelData(
  ...
  companion object {
      val data = listOf(
          ChannelData("RTHK-1", "香港電台", "香港電台第一台", "http://stm.rthk.hk/radio1", R.drawable.rthk1),
          ChannelData("RTHK-2", "香港電台", "香港電台第二台", "http://stm.rthk.hk/radio2", R.drawable.rthk2),
          ChannelData("RTHK-3", "香港電台", "香港電台第三台", "http://stm.rthk.hk/radio3", R.drawable.rthk3),
          ChannelData("RTHK-4", "香港電台", "香港電台第四台", "http://stm.rthk.hk/radio4", R.drawable.rthk4),
          ChannelData("RTHK-5", "香港電台", "香港電台第五台", "http://stm.rthk.hk/radio5", R.drawable.rthk5),
